...
async function handleAdminUI(user) {
  ...
  //hide everything (force reset)
  adminElements.forEach(el => el.style.setProperty("display", "none", "important"));
  superAdminElements.forEach(el => el.style.setProperty("display", "none", "important"));
  ...
  //Superadmin ONLY
  if (role === "superadmin") {
    superAdminElements.forEach(el => el.style.removeProperty("display"));
  }
